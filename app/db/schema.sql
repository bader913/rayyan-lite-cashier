...
CREATE TABLE IF NOT EXISTS products (
  ...
  extra_scan_code TEXT,
  category TEXT,
  supplier TEXT,
  is_weighted INTEGER NOT NULL DEFAULT 0,
  has_parts INTEGER NOT NULL DEFAULT 0,
  part_name TEXT,
  parts_per_unit TEXT NOT NULL DEFAULT '1.0000',
  wholesale_price TEXT NOT NULL DEFAULT '0.0000',
  wholesale_min_qty TEXT NOT NULL DEFAULT '1.0000',
  expiry_date TEXT,
  image_url TEXT,
